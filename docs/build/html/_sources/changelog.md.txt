...
Project release notes are tracked in `CHANGELOG.md` at the repository root.
...
- Unified release checklist for GitHub and PyPI publishing.
- Draw.io architecture diagram for the runtime pipeline.

## 0.1.0 (2026-02-10)

- Initial import-first runtime API and generation engine.
